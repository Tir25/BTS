...
-- Run this script in Supabase SQL Editor (bucket already exists and is private)

-- Step 1: Create storage policies for the private bucket
-- Note: We don't need to enable RLS on storage.objects as it's already enabled by Supabase
...
-- Step 2: Create RLS policies for the users table to include profile photos
...
-- Step 3: Create RLS policies for the buses table to include bus images
...
-- Step 4: Create RLS policies for the routes table to include route maps
