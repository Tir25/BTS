-- University Bus Tracking System Database Initialization Script for Supabase
...
-- Create a test admin user profile (you'll need to create the user in Supabase Auth first)
-- INSERT INTO profiles (id, role, first_name, last_name) VALUES 
-- ('your-user-id-from-supabase-auth', 'admin', 'Admin', 'User')
