...
function appReducer(state: AppState, action: AppAction): AppState {
  switch (action.type) {
    ...
    case 'SET_AUTHENTICATED':
      return { ...state, isAuthenticated: action.payload, authError: null };
    case 'SET_LOADING':
    ...
    case 'SET_CONNECTION_ERROR':
      return { ...state, connectionError: action.payload, connectionStatus: 'disconnected' };
    case 'SET_BUSES':
    ...
    case 'UPDATE_BUS_LOCATION':
      return {
        ...
        buses: state.buses.map(bus =>
          bus.bus_id === action.payload.busId ? { ...bus, currentLocation: action.payload.location } : bus
        ),
      };
    case 'REMOVE_BUS':
      return { ...state, buses: state.buses.filter(bus => bus.bus_id !== action.payload) };
    case 'SET_ROUTES':
    ...
    case 'SET_ROUTE_FILTER_OPEN':
      return { ...state, isRouteFilterOpen: action.payload };
    case 'SET_ACTIVE_BUSES_OPEN':
      return { ...state, isActiveBusesOpen: action.payload };
    case 'TOGGLE_CLUSTERING':
      return { ...state, isClusteringEnabled: !state.isClusteringEnabled };
    case 'TOGGLE_HEATMAP':
      return { ...state, isHeatmapEnabled: !state.isHeatmapEnabled };
    case 'UPDATE_PERFORMANCE':
      return { ...state, lastUpdateTime: action.payload.lastUpdateTime, updateCount: action.payload.updateCount };
    case 'RESET_STATE':
      return initialState;
    default:
      return state;
