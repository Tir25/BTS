...
const DriverHeader: React.FC<DriverHeaderProps & { shiftName?: string | null }> = ({
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl shadow-md p-4 sm:p-6 mb-4 sm:mb-6">
          ...
          <div className="flex flex-wrap gap-2 w-full sm:w-auto">
            {connectionStatus === 'connected' && onRefreshAssignment && (
              <button
                ...
                className="flex-1 sm:flex-none px-3 py-2 bg-green-600 hover:bg-green-700 text-white rounded-xl transition-colors duration-200 text-sm font-medium min-h-[44px] shadow-sm touch-friendly"
            ...
            {connectionStatus === 'disconnected' && onRetryConnection && (
              <button
                ...
                className="flex-1 sm:flex-none px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-colors duration-200 text-sm font-medium min-h-[44px] shadow-sm touch-friendly"
              >
                <span className="flex items-center justify-center gap-1">
                  <span>🔄</span>
            ...
            <button
              onClick={onSignOut}
              className="flex-1 sm:flex-none px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-xl transition-colors duration-200 text-sm font-medium min-h-[44px] shadow-sm touch-friendly"
            >
              <span className="flex items-center justify-center gap-1">
                <span>🚪</span>
